...
# ------------------------------------------------------------------------------
    ...
    if datos_s:
        ...
        # ==============================================================================
        # 3. GRÁFICO 3: PUNTOS CRÍTICOS (INTEGRADO, MISMO DISEÑO, 3 COLUMNAS Y SCROLL)
        # ==============================================================================
        ...
        for pc_id, pc_info in dict_pc_sec.items():
            identificador_pc = f"PC {pc_id} ({pc_info.get('nombre', 'S/C')})"
            conf_pc_pts = [
                ('tag_q', f"{identificador_pc} - Q", False),
                ('tag_p1', f"{identificador_pc} - P1", True)
            ]
